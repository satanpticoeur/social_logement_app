...
Revision ID: e955a876f094
Revises: 
Create Date: 2025-06-27 17:23:28.727300
...
def upgrade():
    ...
    sa.Column('nom_utilisateur', sa.String(length=255), nullable=True),
    sa.Column('email', sa.String(length=255), nullable=False),
    sa.Column('telephone', sa.String(length=255), nullable=True),
    sa.Column('cni', sa.String(length=255), nullable=True),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('mode_paiement', sa.String(length=255), nullable=True),
    sa.Column('periodicite', sa.String(length=255), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('contrat_id', sa.Integer(), nullable=False),
    sa.Column('signale_par', sa.Integer(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('type', sa.String(length=255), nullable=True),
