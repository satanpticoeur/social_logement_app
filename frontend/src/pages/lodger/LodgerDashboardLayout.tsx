...
export default function LodgerDashboardLayoutPage() {
    ...
    useEffect(() => {
        if (!isAuthenticated || user?.role !== 'locataire') {
            toast.error("Accès refusé. Veuillez vous connecter en tant que locataire.");
            navigate('/');
            return;
        }
        setLoading(false);
