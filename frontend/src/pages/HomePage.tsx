...
export const HomePage: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] py-12 px-4 sm:px-6 lg:px-8 bg-background text-foreground"> {/* Utilise bg-background et text-foreground */}
            ...
            <section className="text-center max-w-4xl mb-12">
                ...
                <div className="mt-8 flex justify-center space-x-4">
                    <Link to="/rooms">
                        ...
                        <Button size="lg" className="shadow-md transition duration-300"> {/* Supprime les classes de couleur manuelles */}
                            Découvrir les Chambres
                        </Button>
                    </Link>
                    <Link to="/dashboard">
                        {/* Les boutons "outline" utilisent border et foreground */}
                        <Button variant="outline" size="lg" className="transition duration-300"> {/* Supprime les classes de couleur manuelles */}
                            Espace Propriétaire
                        </Button>
                    </Link>
                </div>
            ...
            <section className="w-full max-w-6xl my-16 p-8 bg-card rounded-lg shadow-xl"> {/* Utilise bg-card */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="bg-primary/10 text-primary rounded-full h-16 w-16 flex items-center justify-center text-3xl font-bold mb-4"> {/* Utilise bg-primary/10 et text-primary */}
                            1
                        </div>
                    ...
                    {/* Étape 2 */}
                    <div className="flex flex-col items-center text-center">
                        <div className="bg-primary/10 text-primary rounded-full h-16 w-16 flex items-center justify-center text-3xl font-bold mb-4">
                            2
                        </div>
            ...
            <section className="w-full max-w-6xl my-16 p-8 bg-secondary rounded-lg shadow-xl"> {/* Utilise bg-secondary */}
                <h2 className="text-4xl font-bold text-center mb-10 text-foreground">
                    Pour les Propriétaires
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-card p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300"> {/* Utilise bg-card */}
            ...
            {/* Section Témoignages */}
            <section className="w-full max-w-6xl my-16 p-8 bg-card rounded-lg shadow-xl text-center"> {/* Utilise bg-card */}
            ...
            {/* Footer */}
            <footer className="w-full py-6 text-center text-muted-foreground border-t border-border mt-12"> {/* Utilise text-muted-foreground et border-border */}
